...
; ==========================================================
; PROCEDIMIENTO: APUTS
; Imprime una cadena terminada en 0 (null-terminated)
; Entrada: SI = Direcci?n de la cadena
; ==========================================================
proc aputs
    push ax
    push dx
...
@@leer_ninja:
    ...
    jcxz @@leer_ninja ; Si CX es 0 (no hay espacio), ignora la tecla
...
@@es_backspace:
    ...
    cmp di, bx      
    je @@leer_ninja ; Si DI == BX, no hay nada que borrar, ignora.
